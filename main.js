...
/***/ function(module, exports, __webpack_require__) {
	...
	var brush = __webpack_require__(10);
	...
	module.exports = {
	    ...
	    events: {
	        'clean-board': function cleanBoard() {
	            this.cleanPaths();
	        }
	    },
	    methods: {
	        ...
	        updateCurrentPath: function updateCurrentPath(p) {
	        ...
	        createSnack: function createSnack() {
	            var that = this;
	            var length = 10,
	                amount = 20,
	                minDis = 2,
	            ...
	            this.snack.onFrame = function (e) {
	                if (that.currentPath) {
	                    ...
	                    if (Math.abs(dx) < minDis && Math.abs(dy) < minDis) {
	                        var p = new Point(Math.random() * view.bounds.width, Math.random() * view.bounds.height);
	        ...
	        cleanPaths: function cleanPaths() {
...
/***/ function(module, exports) {
	...
	var Brush = function Brush() {
	    var type = arguments.length <= 0 || arguments[0] === undefined ? 'pencil' : arguments[0];
	    var color = arguments.length <= 1 || arguments[1] === undefined ? '#333333' : arguments[1];
	    var width = arguments.length <= 2 || arguments[2] === undefined ? 10 : arguments[2];
...
/***/ function(module, exports) {
	...
	module.exports = "<canvas id=\"myCanvas\" resize keepalive=\"true\" :style=\"{'background-color': bgColor}\"></canvas>\r\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        setBrush: function setBrush(type) {
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"tools\">\r\n    <a @click=\"setBrush('pencil')\" href=\"javascript:\" class=\"pencil\">Pencil</a>\r\n    <a @click=\"setBrush('line')\" href=\"javascript:\" class=\"line\">Line</a>\r\n    <a @click=\"cleanBoard()\" href=\"javascript:\" class=\"line\">Clear</a>\r\n    <input type=\"text\" v-model=\"brush.color\"/>\r\n</div>";
